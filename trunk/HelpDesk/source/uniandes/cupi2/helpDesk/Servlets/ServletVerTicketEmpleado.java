...
public class ServletVerTicketEmpleado extends ServletTemplate
{
    ...
    public void escribirContenido( HttpServletRequest request, HttpServletResponse response ) throws IOException
    {
		...
		respuesta.write(" <td width=\"543\"><form method=\"POST\" action=\"empleado.htm\">");
		...
		if(ticket.darFechaAtencion()==null)
		{
			respuesta.write("<tr>");
			respuesta.write(" <td height=\"20\" align=\"right\" valign=\"top\"></td>");
			respuesta.write(" <td valign=\"top\"><p>");
			respuesta.write("  <input type=\"submit\" value=\"Atender\" name=\"B1\" class=\"normal\">");
			respuesta.write(" </td>");
			respuesta.write(" <td valign=\"top\">&nbsp;</td>");
			respuesta.write(" </tr>");
			
		}
		else if(ticket.darFechaCierre()==null)
		{
			respuesta.write("	<tr>");
			respuesta.write("			<td width=\"70\" height=\"20\" align=\"right\" valign=\"top\">");
			respuesta.write("		  <p align=\"right\"><b>Comentario cierre</b></td>");
			respuesta.write("	  <td valign=\"top\"><textarea name=\"comentario2\" cols=\"60\" rows=\"6\" class=\"normal\">Escriba el comentario de cierre aqui.</textarea></td>");
			respuesta.write("  <td valign=\"top\">&nbsp;</td>");
			respuesta.write("</tr>");
			...
			respuesta.write(" <td height=\"20\" align=\"right\" valign=\"top\"></td>");
			respuesta.write(" <td valign=\"top\"><p>");
			respuesta.write("  <input type=\"submit\" value=\"cerrar\" name=\"B1\" class=\"normal\">");
			respuesta.write(" </td>");
			respuesta.write(" <td valign=\"top\">&nbsp;</td>");
			respuesta.write(" </tr>");
		}
		else
		{
			...
			respuesta.write("			<td width=\"70\" height=\"20\" align=\"right\" valign=\"top\">");
			respuesta.write("		  <p align=\"right\"><b>Comentario cierre</b></td>");
			respuesta.write("	  <td valign=\"top\"><textarea name=\"comentario2\" disabled cols=\"60\" rows=\"6\" class=\"normal\">"+ticket.darComentarioEmpleado()+"</textarea></td>");
			respuesta.write("  <td valign=\"top\">&nbsp;</td>");
			respuesta.write("</tr>");
	
			respuesta.write("<tr>");
			respuesta.write(" <td height=\"20\" align=\"right\" valign=\"top\"><b>Calificion</b></td>");
			respuesta.write(" <td valign=\"top\"><p>");
			respuesta.write("<select name=\"calificacion\" disabled class=\"normal\">");
			...
			{
				respuesta.write(" <option value=\"0\" selected>Aun no ha sido calificado</option>");
			}
		...
		respuesta.write(" <form method=\"POST\" action=\"empleado.htm\">");
